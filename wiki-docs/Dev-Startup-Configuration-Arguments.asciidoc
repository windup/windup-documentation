...
Additional arguments are made available to {ProductShortName} rules using a special API. For more information about  {ProductShortName} rules arguments, see link:Rules-Rule-Configuration[Rule Configuration].
