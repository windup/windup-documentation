...
grep 'link:[A-Z]' `find . -name 'Rules-Java-based-Rule-Structure.adoc'`
grep 'link:[A-Z]' `find . -name 'Rules-Basic-Rule-Execution-Flow-Patterns.adoc'`
grep 'link:[A-Z]' `find . -name 'Rules-Create-a-Basic-Java-based-Rule-Add-on.adoc'`
grep 'link:[A-Z]' `find . -name 'Rules-Create-an-Advanced-Ruleset.adoc'`
...
grep 'link:[A-Z]' `find . -name 'Dev-Frames-Extensions.adoc'`
...
grep 'link:[A-Z]' `find . -name 'Dev-Concepts-and-Philosophy.adoc'`
grep 'link:[A-Z]' `find . -name 'Rules-Creating-Rule-Operations.adoc'`
grep 'link:[A-Z]' `find . -name 'Rules-Rulesets.adoc'`
grep 'link:[A-Z]' `find . -name 'Ruleset-Java-Basic-Ruleset.adoc'`
grep 'link:[A-Z]' `find . -name 'Ruleset-Java-Classifications-and-Inline-Hints.adoc'`
grep 'link:[A-Z]' `find . -name 'Ruleset-Java-EE-Apps.adoc'`
...
grep 'link:[A-Z]' `find . -name 'Rules-Rules-Metadata.adoc'`
...
grep 'link:[A-Z]' `find . -name 'Rules-Ops-Xml-XsltTrasformation.adoc'`
