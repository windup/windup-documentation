...
return ConfigurationBuilder.begin()
    .addRule()
    .when(
        JavaClass.references("com.proprietary.example.ProprietaryServlet").at(TypeReferenceLocation.ANNOTATION)
    )
    .perform(
    ...
    .addRule()
    .when(
        JavaClass.references("com.proprietary.example.ProprietaryInitParam").at(TypeReferenceLocation.ANNOTATION)
    )
    .perform(
