...
echo "    Copy the latest JavaDocs files."
echo "        (follow the instructions here to build the JavaDocs: "
echo "             https://github.com/windup/windup/wiki/Dev-Create-the-JavaDoc)"
echo "        cp -r temp/target/apidocs windup/docs/2.4.0.Final/javadocs/"
