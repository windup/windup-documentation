...
You can debug the {ProductName} distribution using one of the following approaches.

. Pass the `--debug` argument on the command line when you execute {ProductName}.
+
--------
