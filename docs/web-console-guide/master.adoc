...
// Reporting issues
include::topics/proc_reporting-issues.adoc[leveloffset=+4]

== Using the {WebName} to analyze applications

You can create a project in the {WebName} to analyze your applications.
...
You can create stakeholders, stakeholder groups, businesses services, and tags in the Controls tab of the {WebName}.

//Creating Stakeholders
include::topics/web-adding-stakeholders.adoc[leveloffset=+2]

//Creating Stakeholder Groups
include::topics/web-adding-stakeholder-groups.adoc[leveloffset=+2]

//Creating Business Services
include::topics/web-adding-business-services.adoc[leveloffset=+2]
