...
include::topics/web-installing.adoc[leveloffset=+1]

// ZIP Installation
include::topics/web-install-zip.adoc[leveloffset=+2]

// Prerequisites
include::topics/web-zip-prerequisites.adoc[leveloffset=+3]

// Install the {WebNameTitle}
include::topics/web-install.adoc[leveloffset=+3]

// Start the {WebNameTitle}
include::topics/web-start.adoc[leveloffset=+3]

// Access the {WebNameTitle}
include::topics/web-access-console.adoc[leveloffset=+3]

// OpenShift Installation
include::topics/web-install-openshift.adoc[leveloffset=+2]

// Prerequisites
include::topics/web-openshift-env.adoc[leveloffset=+3]

// Understanding the {WebNameTitle} OpenShift Image
include::topics/web-openshift-environment.adoc[leveloffset=+3]

// Deploy the {ProductShortName} Application
include::topics/web-openshift-deploy.adoc[leveloffset=+3]

// Access the {WebNameTitle}
include::topics/web-openshift-access.adoc[leveloffset=+3]

// Troubleshoot the {WebNameTitle} OpenShift Install
include::topics/web-openshift-troubleshoot.adoc[leveloffset=+3]
...
include::topics/web-execution-details.adoc[leveloffset=+3]

// Review the Reports
include::topics/web-review-reports.adoc[leveloffset=+3]
...
// Using Custom Rules
include::topics/web-custom-rules.adoc[leveloffset=+1]
