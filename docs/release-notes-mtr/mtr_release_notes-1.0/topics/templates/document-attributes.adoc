...
:PluginName: {ProductShortName} plugin
...
:IntroTo{ProductShortName}BookName: Introduction to the {DocInfoProductName}
...
:ProductDocIntroTo{ProductShortName}GuideURL: https://access.redhat.com/documentation/en-us/{DocInfoProductNameURL}/{DocInfoProductNumber}/html-single/introduction_to_the_{DocInfoProductNameURL}
...
:{ProductShortName}DownloadPageURL: https://developers.redhat.com/products/mta/download
