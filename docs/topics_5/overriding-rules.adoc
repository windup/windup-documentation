...
+
Custom rules can be placed in either `__MTA_HOME__/rules`, `${user.home}/.mta/rules/`, or the directory specified by the `--userRulesDirectory` command-line argument.
