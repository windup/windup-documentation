...
----
$ __MTA_HOME__/bin/mta-cli --input /path/to/jee-example-app-1.0.0.ear --output /path/to/output --target eap:6 --packages com.acme org.apache --mavenize
----
...
The `/path/to/output/mavenized/__APPLICATION_NAME__/` directory will contain the following items:
