...
* Installation on macOS: The value of `maxproc` must be `2048` or greater.
endif::[]
...
* link:http://www.eclipse.org/downloads/[Eclipse]

_and_

* JBoss Tools installed from the Eclipse marketplace. For more information, navigate to link:https://www.eclipse.org/[Eclipse], click *More* -> *Documentation*, and then select *Eclipse Marketplace User Guide*.
endif::[]
