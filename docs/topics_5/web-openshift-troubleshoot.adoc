...
. Access the OpenShift console by navigating to `__OPENSHIFT_URL__/console/project/mta/overview`. If you renamed the OpenShift project when xref:deploy_mta_app_openshift[deploying], be sure to replace `mta` in this URL with the name of your project.
