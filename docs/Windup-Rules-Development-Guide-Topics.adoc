...
If you would like to contribute to the {ProductName} source code base or provide Java-based rule add-ons, see the {ProductDocCoreGuideURL}[{ProductName} Core Development Guide].
