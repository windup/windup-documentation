...
* If you build {ProductShortName} from GitHub source, {ProductHomeVar} refers to the {ProductDistribution} folder extracted from the {ProductName} source dist/target/{ProductDistribution}.zip file.
