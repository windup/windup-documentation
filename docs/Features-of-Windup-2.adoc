...
Shared Data Model:: Windup 2 creates a shared data model graph that provides the following benefits.
...
Windup 2 has the ability to automate some of the migration processes.
...
Windup 2  reports are now targeted for specific audiences.
