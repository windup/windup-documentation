...
The build process creates a `windup-distribution-2.2.0-SNAPSHOT-offline.zip file` in the Windup source `dist/target/` directory. 

Unzip the `dist/target/windup-distribution-2.2.0-SNAPSHOT-offline.zip` file into a directory of your choice.
