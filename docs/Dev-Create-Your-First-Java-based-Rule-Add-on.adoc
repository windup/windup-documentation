...
[options="nowrap"]
----
For Linux:    WINDUP_HOME/bin/windup --sourceMode true --input WORKSPACE_PATH/proprietary-annotation-example/src/test/ --output WORKSPACE_PATH/proprietary-annotation-example/windup-reports --packages com.proprietary

For Windows:  WINDUP_HOME\bin\windup.bat --sourceMode true --input WORKSPACE_PATH\proprietary-annotation-example\src\test\ --output WORKSPACE_PATH\proprietary-annotation-example\windup-reports --packages com.proprietary
----
