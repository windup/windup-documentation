...
In general, {ProductShortName} spends about 40% of the time decompiling classes, 40% of the time executing rules, and the remainder of the time processing other tasks and generating rules. This section describes what you can do to improve the performance of {ProductShortName}.
