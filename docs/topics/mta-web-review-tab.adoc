...
You can review the settings of any application or archetype directly from the list.
...
+
. Click the *Review* tab in the view. The application information appears, showing the application's questions.
