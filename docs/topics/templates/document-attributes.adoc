...
:DocInfoProductNumber: 4.0.Beta1
...
// ********************
:ProductRelease: 4
:ProductVersion: 4.0.Beta1
:ProductDistributionVersion: 4.0.0.Beta1
:ProductDistribution: rhamt-cli-distribution-{ProductDistributionVersion}
