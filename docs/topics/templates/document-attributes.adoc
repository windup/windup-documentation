...
:VscodePluginName: Visual Studio Code
:VscodeNamePluginTitle: Visual Studio Code extension
:VscodePluginShortName: VS Code
...
:VscodePluginBookName: Visual Studio Code Extension Guide
