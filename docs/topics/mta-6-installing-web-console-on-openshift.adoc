...
|100 GiB
|Size requested for the cache volume. When `rwx_supported=false`, this option is ignored.

|`cache_storage_class`
|Default storage class
|Storage class used for the cache volume. When `rwx_supported=false`, this option is ignored.
...
|100 GiB
|Size requested for the Maven m2 repository volume. This option is deprecated.

|`rwx_storage_class`
|NA
|Storage class requested for the Tackle RWX volumes. This option is deprecated.
