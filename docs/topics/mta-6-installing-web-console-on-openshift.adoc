...
{ProductShortName} does not enable RHSSO external access by default. The RHSSO operator can create a route and expose single sign-on for you to configure using the OpenShift Container Platform web console.
