...
Hat Single Sign-On] (RHSSO) instance, using the Keycloak CR of Red Hat Single
Sign-On Operator.

The {ProductShortName} RHSSO realm is fully configured by the Hub.
