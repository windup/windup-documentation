...
|100 GiB
|Size requested for the Maven m2 repository volume; deprecated in {ProductShortName} {ProductVersion}

|`rwx_storage_class`
|NA
|Storage class requested for the Tackle RWX volumes; deprecated in {ProductShortName} {ProductVersion}
