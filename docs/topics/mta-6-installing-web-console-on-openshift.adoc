...
require RHSSO, you can configure it by using the Tackle CR attribute
`rhsso_external_access`. Otherwise, use the {ProductShortName} realm administration console to
adjust the settings.
