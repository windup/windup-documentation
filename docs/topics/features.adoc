...
{ProductName} (RHAMT) provides a number of capabilities to assist with planning and executing migration projects.
...
// WAS: {ProductShortName} produces numerous xref:review_reports[reports] to give both ...
//TODO: For more information on the various RHAMT reports, see the Reports guide?
