...
+
Custom rules can be placed in either `RHAMT_HOME/rules`, `${user.home}/.windup/rules/`, or the directory specified by the `--userRulesDirectory` command-line argument.
