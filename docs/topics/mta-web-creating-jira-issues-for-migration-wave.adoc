...
* You configured Jira connection. For more information, see xref:creating-configuring-jira-connection_user-interface-guide[Creating and configuring a Jira connection].
