...
Access the report at `/home/USER_NAME/migration-rules/reports/index.html` to be sure it provides the expected results.

For a more detailed walkthrough of reports, see the link:{ProductDocUserGuideURL}#Review-the-Report[Review the Report] section of the _{ProductShortName} User Guide_.
