...
When deleting, deactivating or degarding the role of a user, such as changing the user from `Admin` to `Migrator`, the change takes several minutes to take effect. This delay in changing the user status may pose an operational or security risk. link:https://issues.redhat.com/browse/MTA-1809[MTA-1809]
