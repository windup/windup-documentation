...
The following instructions detail creating a JUnit test using the Red Hat JBoss Developer Studio. When using a different IDE it is recommended to consult your IDE's documentation for instructions on creating a JUnit test.
