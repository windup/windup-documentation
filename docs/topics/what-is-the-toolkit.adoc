...
See the link:{ProductDocIntroTo{ProductShortName}GuideURL}[_{IntroTo{ProductShortName}BookName}_] to learn more about the features, supported configurations, system requirements, and available tools in the {ProductName}.
