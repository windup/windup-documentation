...
[NOTE]
====
Note that the automatically attached tags are displayed only after the analysis has been run.
Instead of enabling automated tagging or in addition to it, you might want to attach tags to the application manually.
====
+
[NOTE]
====
