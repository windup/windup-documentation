...
. If you choose *Upload a local binary*, you are prompted to *Upload a local binary*. Either drag and drop a file into the area provided or click *Upload* and select the file to upload.
. Click *Next*.
...
** OpenJDK 17
** OpenJDK 21
* Linux. Use this option to you ensure that there are no Microsoft Windows paths hard-coded into your applications.
...
. Click *Next*.
. In *Advanced*, you can attach additional custom rules to the analysis by select the *Manual* or *Repository* mode:
