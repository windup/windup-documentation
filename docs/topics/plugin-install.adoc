...
A Minimum Viable Product release of the extension is provided in this release of {ProductShortName}.
The extension is not supported for use in production environments.
