...
* If you are using Eclipse, and not Red Hat Developer Studio, then you must xref:install_jboss_tools[install JBoss Tools] before installing the {PluginNameTitle}.
