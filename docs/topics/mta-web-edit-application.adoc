...
. To change application settings, click {icon-edit} to open the application settings, and review the application settings. See procedure above for a list of application settings.
