...
{ProductShortName} analyzes applications by applying one or more rulesets to each application considered, determining which specific lines of that application must be modified before it can be migrated or modernized.
