...
For more information, see xref:../../../docs/web-console-guide/master.adoc#mta-web-create-config-jira-connection_user-interface-guide[Configuring Jira connections].
...
For more information, see xref:../../../docs/web-console-guide/master.adoc#mta-web-creating-jira-issues-for-migration-wave_user-interface-guide[Creating migration waves].
