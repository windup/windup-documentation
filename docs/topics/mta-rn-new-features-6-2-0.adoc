...
For more information, see xref:../../../docs/topics/mta-web-config-jira-connection.adoc#mta-web-config-jira-connection[Configuring Jira connection].
...
For more information, see xref:../../../docs/topics/mta-web-creating-jira-issues-for-migration-wave.adoc#mta-web-creating-jira-issues-for-migration-wave[Creating migration waves].
