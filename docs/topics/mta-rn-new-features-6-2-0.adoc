...
For more information, see xref:../../../docs/web-console-guide/master.adoc#mta-web-create-config-jira-connection_user-interface-guide[Configuring Jira connection].
