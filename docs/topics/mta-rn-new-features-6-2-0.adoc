...
For more information, see xref:../../../docs/web-console-guide/master.adoc#creating-configuring-jira-connection_{context}[Creating and configuring a Jira connection].
...
For more information, see xref:../../../docs/topics/mta-web-creating-migration-waves.adoc#mta-web-creating-migration-waves_{context}[Creating migration waves] and xref:../../../docs/topics/mta-web-creating-jira-issues-for-migration-wave.adoc#mta-web-creating-jira-issues-for-migration-wave_{context}[Creating Jira issues for a migration wave].
