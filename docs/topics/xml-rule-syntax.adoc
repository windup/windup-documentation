...
* **<ruleset id="__UNIQUE_RULESET_ID__">**: Defines this as a {ProductShortName} ruleset and gives it a unique ruleset ID.
...
{ProductShortName} provides predefined rules for common migration requirements. These core {ProductShortName} rules are located in the {ProductShortName} installation at `__RHAMT_HOME__/rules/migration-core/`.
