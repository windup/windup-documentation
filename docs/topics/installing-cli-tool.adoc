...
. Copy or save the `mta-cli` binary to a known directory.
+
Continue to link:https://access.redhat.com/documentation/en-us/migration_toolkit_for_applications/7.0/html/cli_guide/installing_and_running_the_cli#cli-run_cli-guide[Running the CLI] to run the CLI command.
