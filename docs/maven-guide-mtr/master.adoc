...
{ProductShortName} uses Jira as its issue tracking system. If you encounter an issue executing {ProductShortName}, submit a link:{JiraMTRURL}[MTR Jira issue] or {JiraMTAURL}[MTA Jira issue].
