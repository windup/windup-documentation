...
[id="mta-6-2-3"]
== {ProductShortName} 6.2.3

include::topics/mta-rn-resolved-issues-6-2-3.adoc[leveloffset=+2]

include::topics/mta-rn-known-issues-6-2-3.adoc[leveloffset=+2]

[id="mta-6-2-2"]
== {ProductShortName} 6.2.2

include::topics/mta-rn-resolved-issues-6-2-2.adoc[leveloffset=+2]

include::topics/mta-rn-known-issues-6-2-2.adoc[leveloffset=+2]
